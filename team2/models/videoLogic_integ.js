...
module.exports.handleAlgInput = function(req, res) {
    module.exports.getNextSOC('1', req.query['salary'], req.query['education'],
        function (socs) {
            console.log(socs);
        },
        function (err) {
...
module.exports.getNextSOC = function(userId, salary, edu, successNext, errNext){
            ...
            module.exports.getUnviewedSOCList(userId, 
                function (ul){
                    unviewedList = ul;
                    module.exports.getRatedSOCList(userId, salary, edu,
                    function (rl){
                        ratedsocList = rl;
...
module.exports.getRatedSOCList = function(userId, salary, edu, successNext, errNext){
    var connection = mysql.createConnection(config);
    connection.connect();
